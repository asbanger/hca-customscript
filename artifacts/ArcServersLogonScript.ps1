$Env:ArcBoxDir = "C:\OnPremise"
$Env:ArcBoxLogsDir = "$Env:ArcBoxDir\Logs"
$Env:ArcBoxVMDir = "$Env:ArcBoxDir\Virtual Machines"
$Env:ArcBoxIconDir = "C:\OnPremise\Icons"
...
Add-DhcpServerv4Scope -Name "OnPremise" `
...
New-VM -Name OnPremise-Win2K19 -MemoryStartupBytes 12GB -BootDevice VHD -VHDPath "$Env:ArcBoxVMDir\ArcBox-Win2K19.vhdx" -Path $Env:ArcBoxVMDir -Generation 2 -Switch $switchName
Set-VMProcessor -VMName OnPremise-Win2K19 -Count 2

New-VM -Name OnPremise-Win2K22 -MemoryStartupBytes 12GB -BootDevice VHD -VHDPath "$Env:ArcBoxVMDir\ArcBox-Win2K22.vhdx" -Path $Env:ArcBoxVMDir -Generation 2 -Switch $switchName
Set-VMProcessor -VMName OnPremise-Win2K22 -Count 2
...
Set-VMProcessor -VMName OnPremise-SQL -Count 2
...
Set-VMFirmware -VMName OnPremise-Ubuntu -EnableSecureBoot On -SecureBootTemplate 'MicrosoftUEFICertificateAuthority'
Set-VMProcessor -VMName ArcBox-Ubuntu -Count 1

New-VM -Name OnPremise-CentOS -MemoryStartupBytes 4GB -BootDevice VHD -VHDPath "$Env:ArcBoxVMDir\ArcBox-CentOS.vhdx" -Path $Env:ArcBoxVMDir -Generation 2 -Switch $switchName
Set-VMFirmware -VMName OnPremise-CentOS -EnableSecureBoot On -SecureBootTemplate 'MicrosoftUEFICertificateAuthority'
Set-VMProcessor -VMName OnPremise-CentOS -Count 1

# We always want the VMs to start with the host and shut down cleanly with the host
Write-Header "Set VM Auto Start/Stop"
Set-VM -Name OnPremise-Win2K19 -AutomaticStartAction Start -AutomaticStopAction ShutDown
Set-VM -Name OnPremise-Win2K22 -AutomaticStartAction Start -AutomaticStopAction ShutDown
Set-VM -Name OnPremise-SQL -AutomaticStartAction Start -AutomaticStopAction ShutDown
Set-VM -Name OnPremise-Ubuntu -AutomaticStartAction Start -AutomaticStopAction ShutDown
Set-VM -Name OnPremise-CentOS -AutomaticStartAction Start -AutomaticStopAction ShutDown
...
Start-VM -Name OnPremise-Win2K19
Start-VM -Name OnPremise-Win2K22
Start-VM -Name OnPremise-SQL
Start-VM -Name OnPremise-Ubuntu
Start-VM -Name OnPremise-CentOS
...
Invoke-Command -VMName OnPremise-Win2K19 -ScriptBlock { Get-NetAdapter | Restart-NetAdapter } -Credential $winCreds
Invoke-Command -VMName OnPremise-Win2K22 -ScriptBlock { Get-NetAdapter | Restart-NetAdapter } -Credential $winCreds
Invoke-Command -VMName OnPremise-SQL -ScriptBlock { Get-NetAdapter | Restart-NetAdapter } -Credential $winCreds
Start-Sleep -Seconds 5

# Configure the OnPremise Hyper-V host to allow the nested VMs onboard as Azure Arc-enabled servers
Write-Header "Blocking IMDS"
Write-Output "Configure the OnPremise VM to allow the nested VMs onboard as Azure Arc-enabled servers"
Set-Service WindowsAzureGuestAgent -StartupType Disabled -Verbose
Stop-Service WindowsAzureGuestAgent -Force -Verbose
New-NetFirewallRule -Name BlockAzureIMDS -DisplayName "Block access to Azure IMDS" -Enabled True -Profile Any -Direction Outbound -Action Block -RemoteAddress 169.254.169.254

# Getting the Ubuntu nested VM IP address
$UbuntuVmIp = Get-VM -Name OnPremise-Ubuntu | Select-Object -ExpandProperty NetworkAdapters | Select-Object -ExpandProperty IPAddresses | Select-Object -Index 0

# Getting the CentOS nested VM IP address
$CentOSVmIp = Get-VM -Name OnPremise-CentOS | Select-Object -ExpandProperty NetworkAdapters | Select-Object -ExpandProperty IPAddresses | Select-Object -Index 0
...
Copy-VMFile OnPremise-Win2K19 -SourcePath "$agentScript\installArcAgentModified.ps1" -DestinationPath C:\OnPremise\installArcAgent.ps1 -CreateFullPath -FileSource Host
Copy-VMFile OnPremise-Win2K22 -SourcePath "$agentScript\installArcAgentModified.ps1" -DestinationPath C:\OnPremise\installArcAgent.ps1 -CreateFullPath -FileSource Host
Copy-VMFile OnPremise-SQL -SourcePath "$agentScript\installArcAgentSQLModified.ps1" -DestinationPath C:\OnPremise\installArcAgentSQL.ps1 -CreateFullPath -FileSource Host
...
Invoke-Command -VMName OnPremise-Win2K19 -ScriptBlock { powershell -File C:\OnPremise\installArcAgent.ps1 } -Credential $winCreds
Invoke-Command -VMName OnPremise-Win2K22 -ScriptBlock { powershell -File C:\OnPremise\installArcAgent.ps1 } -Credential $winCreds
Invoke-Command -VMName OnPremise-SQL -ScriptBlock { powershell -File C:\OnPremise\installArcAgentSQL.ps1 } -Credential $winCreds
...
# Changing to Jumpstart OnPremise wallpaper
$code = @' 
