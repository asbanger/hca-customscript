...
# Creating OnPremise Hyper-V path
Write-Output "Creating OnPremise path"
$Env:ArcBoxDir = "C:\OnPremise"
$Env:ArcBoxLogsDir = "C:\OnPremise\Logs"
$Env:ArcBoxVMDir = "C:\OnPremise\Virtual Machines"
$Env:ArcBoxKVDir = "C:\OnPremise\KeyVault"
$Env:ArcBoxGitOpsDir = "C:\OnPremise\GitOps"
$Env:ArcBoxIconDir = "C:\OnPremise\Icons"
$Env:agentScript = "C:\OnPremise\agentScript"
